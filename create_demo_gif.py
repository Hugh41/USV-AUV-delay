...
Usage:
    python create_demo_gif.py                        # auto-detect latest result
    python create_demo_gif.py --result path/to.json  # specific result file
    python create_demo_gif.py --n_auv 3              # filter by AUV count
    python create_demo_gif.py --fps 15 --duration 8  # animation params
"""
